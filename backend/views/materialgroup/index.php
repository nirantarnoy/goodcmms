...
/** @var backend\models\MaterialgroupSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'กลุ่มอุปกรณ์/เครื่องจักร';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="materialgroup-index">
    <div class="panel panel-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-2" style="text-align: right">
                <form id="form-perpage" class="form-inline" action="<?= Url::to(['materialgroup/index'], true) ?>"
                      method="post">
