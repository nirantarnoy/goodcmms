...
/* @var $searchModel backend\models\AssetlocationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'ที่ตั้งเครื่องจักร์/อุปกรณ์';
  ...
  <div class="panel panel-body">
      ...
      <div class="row">
          ...
          <div class="col-lg-2" style="text-align: right">
              <form id="form-perpage" class="form-inline" action="<?= Url::to(['assetlocation/index'], true) ?>"
                    method="post">
